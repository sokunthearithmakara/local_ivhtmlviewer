...
class fbform extends \mod_flexbook\form\base_form {
    ...
    public function set_data_for_dynamic_submission(): void {
        ...
        $data = \local_ivhtmlviewer\helper::prepare_html_data($data, 'mod_flexbook');
        $this->set_data($data);
    }
    ...
    public function process_dynamic_submission() {
        ...
        \local_ivhtmlviewer\helper::save_html_data($fromform, 'mod_flexbook');
        return $fromform;
    }
    ...
    public function definition() {
        ...
        \local_ivhtmlviewer\helper::add_htmlviewer_elements($mform);
    ...
    public function validation($data, $files) {
        ...
        $errors = array_merge($errors, \local_ivhtmlviewer\helper::validate_htmlviewer_elements($data, $files));
        return $errors;
    }
}
