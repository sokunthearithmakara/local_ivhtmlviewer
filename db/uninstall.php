...
/**
 * Uninstall script for htmlviewer.
 *
...
/**
 * Uninstall function for the local_ivhtmlviewer plugin.
 *
 * @return bool Always returns true.
 */
function xmldb_local_ivhtmlviewer_uninstall() {
    $config = array_filter(explode(',', get_config('mod_interactivevideo', 'enablecontenttypes') ?: ''));
    $config = array_diff($config, ['local_ivhtmlviewer']);
